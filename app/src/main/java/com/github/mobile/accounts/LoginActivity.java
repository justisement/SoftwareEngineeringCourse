...
import jp.forkhub.HistoryActivity;
...
public class LoginActivity extends RoboActionBarAccountAuthenticatorActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        historyView = findViewById(R.id.historybutton);  // get the button, it is in activity_main.xml
        ...
        btn_open = findViewById(R.id.browser);
        btn_open.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                //String address = et_web.getText().toString().trim();
                Intent intent = new Intent();
                intent.setAction("android.intent.action.VIEW");
                Uri content_url = Uri.parse("http://www.github.com");
